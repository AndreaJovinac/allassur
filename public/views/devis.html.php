<h2 style="margin: 30px 0px 30px 0px;"> Demande de devis : Particulier </h2>
                            ...
                            <form id="contact-form" method="post" action="" role="form" style="margin-top: 30px;" action="contactdevis.php">
                                    ...
                                    <h5 style="margin-top: 20px; color: #a34d1f;"> 
                                        <strong>2) Vous désirez être contacter par <span class="blue">*</span> : </strong> </h5>
                                    ...
                                    <div class="" style="margin-bottom: 50px;"> 
                                        <h5 class="" style="margin-top: 30px; margin-bottom: 20px; color: #a34d1f;"><strong> 3) Remplissez vos donnés personnelles et votre message :</strong> </h5>
                                        
                                            <div class=" col-lg-6 col-sm-12 col-xs-12" style="padding: 0; margin-bottom: 15px;"> 
                                                ...
                                                <div class="checkbox float-right col-sm-6 col-xs-12 col-lg-6" style="padding: 0;">
                                                            <label><input type="radio" name="sexe" id="sexe" value=""> Femme </label>
                                                </div>
                                                <div class="checkbox col-sm-6 col-xs-12 col-lg-6" style="padding: 0;">
                                                            <label><input type="radio" name="sexe" id="sexe" value=""> Homme </label>
                                                </div>
                                                <p class="comments" style="color: red; margin-top: 5px;"></p>
                                            </div>
